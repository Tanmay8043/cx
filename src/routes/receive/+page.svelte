...
var recvId, status, message, standbyBox, goBox, fadeBox, offBox, sendMessageBox, sendButton, clearMsgsButton;
    ...
    onMount(async()=>{
        ...
        standbyBox = document.getElementById("standby");
        goBox = document.getElementById("go");
        fadeBox = document.getElementById("fade");
        offBox = document.getElementById("off");
